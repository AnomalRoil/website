+++
title = "CTF Writeup / Y-Not-CTF / SmS Secret Secure Server"
description = "Done as a member of the duks team."
tags = [
    "crypto",
	"ctf"
]
date = 2017-11-17T19:00:00Z
author = "Yolan"
math = true
+++

*We were given a ssh username, server ip and public key using ECDSA, along with a _very secure RNG_ python script used to generate the ECDSA key. Exploiting a weakness in the RNG, we can enumerate all possible keys and find the private key to log on the server.*
